...
class MainActivity : AppCompatActivity() {
    ...
    private fun setRivalryListView() {
    ...
    private fun makeData() {
        if (Player.players.size == 0) {
            ...
            PartialGame.makePartialGame(3, matt.id, "Undercut", 2)
            ...
            PartialGame.makePartialGame(6, scott.id, "Undercut", 0)
            ...
            PartialGame.makePartialGame(7, scott.id, "Undercut", 3)
